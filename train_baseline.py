    ...
    for epoch in range(args.epochs):
        ...
        for i, (inputs, labels) in enumerate(train_loader):
            ...
            if i % 100 == 0:
                ...
                ml_recall = ml_recall/227.0
                ml_precision = ml_precision/227.0

                print('{} Epoch, {} Iter,Time :{:.3f},Data:{:.3f} Loss: {:.4f}, Acc: {:.4f}, AUPRC: {:.4f}, PREC: {:.4f}, REC: {:.4f}'.format(
                    epoch, i, batch_time.avg, data_time.avg, loss.item(), ml_acc, ml_auprc, ml_precision, ml_recall))
